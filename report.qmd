...
in @fig-2, which shows the residual of the global model, and there
appears to be a spatial pattern to the residuals, with specific areas
showing clusters of higher residuals and the other regions showing
...
global model. From the plot, the prominent dark purple areas in the
central part of the country, extending towards the southeastern regions,
...
eastern regions, is colored in various shades of purple. This suggests
that in these areas, an increased percentage of the Asian population
...
white_plot = ggplot(gwr_results_sf) +
  ...
  labs(title = "Local Significance and Magnitude of '% White'",
...
black_plot = ggplot(gwr_results_sf) +
  ...
  scale_fill_gradient2(low = "blue", mid = "white", high = "red", na.value = "white", 
                      name = "Magnitude", limits = NULL) +  
  labs(title = "Local Significance and Magnitude of '% African American'",
       subtitle = "Geographically Weighted Regression (GWR)",
       caption = "Blue indicates lower magnitude of effect;\n Red indicates larger magnitude of effect;\nWhite indicates no significant effect") +
  theme_minimal() +
  theme(text = element_text(size = 10), legend.position = "right")
...
hispan_plot = ggplot(gwr_results_sf) +
  ...
  scale_fill_gradient2(low = "blue", mid = "white", high = "red", na.value = "white", 
                      name = "Magnitude", limits = NULL) +  
  labs(title = "Local Significance and Magnitude of '% Hispanic'",
       subtitle = "Geographically Weighted Regression (GWR)",
       caption = "Blue indicates lower magnitude of effect;\n Red indicates larger magnitude of effect;\nWhite indicates no significant effect") +
  theme_minimal() +
  theme(text = element_text(size = 10), legend.position = "right")
...
asian_plot = ggplot(gwr_results_sf) +
  ...
  scale_fill_gradient2(low = "blue", mid = "white", high = "red", na.value = "white", 
                      name = "Magnitude", limits = NULL) +  
  labs(title = "Local Significance and Magnitude of '% Asian'",
       subtitle = "Geographically Weighted Regression (GWR)",
       caption = "Blue indicates lower magnitude of effect;\n Red indicates larger magnitude of effect;\nWhite indicates no significant effect") +
  theme_minimal() +
  theme(text = element_text(size = 10), legend.position = "right")
...
ggsave("whiteplot.png", plot = white_plot)
ggsave("blackplot.png", plot = black_plot)
ggsave("hispanplot.png", plot = hispan_plot)
ggsave("asianplot.png", plot = asian_plot)
```

::: {#fig-race layout="[[50,50],[50,50]]"}
![Figure 3a](whiteplot.png){#fig-3}

![Figure 3b](blackplot.png){#fig-4}

![Figure 3c](hispanplot.png){#fig-5}

![Figure 3d](asianplot.png){#fig-6}
:::
...
ggsave("medIncomePlot.png", plot = medianIncome)
ggsave("unemployPlot.png", plot = unemployment)

```

::: {#fig-econ layout="[[50,50],[50,50]]"}
![Figure 5a](medIncomePlot.png){#fig-8}

![Figure 5b](unemployPlot.png){#fig-9}
:::
...
collin = gwr.collin.diagno(Data_Vl ~ 
                          ...
                          adaptive = FALSE)
VIF = head(collin$VIF)
print(xtable(VIF), type = "latex", include.rownames = FALSE)
```
...
our model, as it shows multicollinearity with respect to the white
variable, however, this is to be expected given that the white
population makes up a majority of the United States.
